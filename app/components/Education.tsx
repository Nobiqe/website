  ...
  const education = [
    {
      ...
      institution: "Shahid Chamran University of Ahvaz (Jundi Shapur)",
      period: "October 2023 – September 2024",
      achievements: [
        "Specialized in AI and machine learning technologies",
        "Focused on natural language processing and deep learning research",
        "Developed advanced skills in AI model development and implementation",
      ],
    },
    {
      ...
      achievements: [
        "Built strong foundation in computer science and engineering principles",
        "Developed technical skills in programming and system administration",
        "Gained practical experience through hands-on projects and coursework",
      ],
    },
  ]
